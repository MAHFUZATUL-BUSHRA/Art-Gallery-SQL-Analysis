...
WHERE
    M.MUSEUM_ID IS NULL;  -- Output -- There is no museuems without any painting
...
FROM
    product_size
WHERE
    sale_price > regular_price; -- Output -- There is no paintings have an asking price of more than their regular price.
